...
public class EnemySpriteController : MonoBehaviour
{
	...
	public void Setup(EnemyBase me, EnemyChart chart)
	{
		...
		Frame.sprite = Resources.Load<SpriteAtlas>("Sprites/Icons").GetSprite("EnemyFrame_" + chart.Shape.ToString() + "_" + chart.Attr.ToString());
		Bg.sprite = Resources.Load<SpriteAtlas>("Sprites/Icons").GetSprite("EnemyBg_" + chart.Shape.ToString() + "_" + chart.Attr.ToString());
	}
