...
public class ExampleFSM: MonoBehaviour
{
    ...
    private StateMachine<ExampleFSM> _ownerStateMachine = null;
    ...
    private void Start()
    {
        ...
        _ownerStateMachine = new StateMachine<ExampleFSM>(this);
    ...
    /// </summary>
    private class OwnerStartState : State<ExampleFSM>
    {
        private int _count = 0;
    ...
    private class OwnerEndState : State<ExampleFSM>
    {
        protected override void Begin()
        {
            // 처음 상태로 다시 원상복귀
